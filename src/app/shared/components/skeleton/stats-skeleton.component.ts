    ...
    <div class="stats-skeleton">
      <div class="stat-item-skeleton" *ngFor="let stat of getStatsArray(); trackBy: trackByIndex">
        <div class="stat-icon-skeleton">
          ...
          <app-skeleton [config]="{ type: 'title', width: '100%', height: '10%' }"></app-skeleton>

        </div>
        <div class="stat-content-skeleton">
          <div class="stat-value-skeleton">
            <app-skeleton [config]="{ type: 'title', width: '100%', height: '100%' }"></app-skeleton>
          </div>
          <div class="stat-label-skeleton">
            <app-skeleton [config]="{ type: 'text', width: '100%', height: '100%' }"></app-skeleton>
          </div>
        </div>
